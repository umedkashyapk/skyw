...
<div class="col-sm-9">
  <h4 class="page-title">Undelivered Franchise Order</h4>
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index">Home</a></li>
    <li class="breadcrumb-item"><a href="#">Franchise</a></li>
    <li class="breadcrumb-item active" aria-current="page"> Undelivered Franchise Order</li>
  </ol>
...
$total_product_bv=array();
        $ttl=$this->conn->runQuery('sum(order_mrp)as total,sum(order_amount)as charge,sum(order_bv) as bv','franchise_orders',"status='0'");
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?= $t_data['added_on'];?></td>
                               <td><a href="<?= $admin_path.'franchise/order_product_view_old?order_id='.$t_data['id'];?>" class="btn btn-success btn-sm" >View</a>
                             </td>
