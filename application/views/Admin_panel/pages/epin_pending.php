<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title"> Pending Epin</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <li class="breadcrumb-item"><a href="#"> Epin</a></li>            
            <li class="breadcrumb-item active" aria-current="page">Epin</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase"> Pending Epin</h6>
<hr>
<?php
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
         <form action="<?= $admin_path.'pin/pending';?>" method="post">
             <div class="form-inline">
                 ...
                 <input type="submit" name="submit" class="btn btn-sm" value="filter" />&nbsp;
                  <a href="<?= $admin_path.'pin/pending';?>" class="btn btn-sm">Reset</a>
        ...
        if($table_data){
            ...
            <tr>
                ...
                <td><?= $t_data['added_on'];?></td>                                
                 <td><a class="btn btn-sm btn-info" href="<?= $admin_path.'pin/view?id='.$t_data['id'];?>">View</a></td>           
            </tr>
            <?php
            }
        }
