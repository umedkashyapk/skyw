                        ...
                        <table class="table table-bordered table-hover">
    				        ...
    				        if($my_accounts_arr){
        				                ...
        				                <tr>
                				            ...
                				            <td>
                				                ...
                				                if($default!=($indx)){
                				                    $sd_id=$indx+1;
                    				                ?>
                    				                <a href="<?= $admin_path.'payment/add_account';?>?delete=<?= $sd_id;?>" class="text-danger fs-10">delete</a> <a href="<?= $admin_path.'payment/add_account';?>?default=<?= $sd_id;?>" class="text-info fs-10">Set default</a>
                    				                <?php
                				                }
                				                ?>
                				            </td>
    				            ...
    				            ?>
    				            <tr>
    				                <td colspan=4><center><a class="btn btn-info" href="<?= $admin_path.'payment/add_account';?>">Add Account</a></center></td>
    				            </tr>
