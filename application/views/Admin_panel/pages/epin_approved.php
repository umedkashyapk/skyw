<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title"> Approved Epin</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <li class="breadcrumb-item"><a href="#">  Approved Epin</a></li>            
            <li class="breadcrumb-item active" aria-current="page"> Approved Epin</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase">  Approved Epin</h6>
<hr>
<?php
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <form action="<?= $admin_path.'pin/approved';?>" method="post">
             <div class="form-inline">
                 ...
                 <a href="<?= $admin_path.'pin/approved';?>" class="btn btn-sm">Reset</a>
