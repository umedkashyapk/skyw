<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title"> Approved Fund Request</h4>
		    <ol class="breadcrumb">
...
<h6 class="text-uppercase"> Approved Fund Request</h6>
<hr>
<?php
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?= $admin_path.'fund/approved';?>" method="get">
             <div class="form-inline">
                 ...
                 <a href="<?=$admin_path.'fund/approved';?>"class="btn btn-sm">Reset</a>
