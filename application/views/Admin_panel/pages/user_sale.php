 ...
 if(isset($_GET['order_id'])){
    ...
    $table_data=$this->conn->runQuery('*','order_items',"order_id='$order_id'");
    $u_id=$table_data[0]->u_code;
    $user_detail=$this->conn->runQuery('*','users',"id='$u_id'");
   // print_r($table_data);
    $franchise_u_id=$table_data[0]->franchise_id;
   ...
   <!-- <center>
          ...
          <!-- <center><h5>Bill</h5></center>-->
           ...
           <p>
               ...
               Username: <?= $user_detail[0]->username;?></br>
              Name: <?= $user_detail[0]->name;?></br>
            </p> 
            </div> </div></div>
            <div class="row">
