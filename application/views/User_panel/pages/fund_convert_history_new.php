...
<section class="earning-sec">
        <div class="container">
            ...
            <div class="formContainer">
               <form action="<?= $panel_path.'fund/fund-convert-history'?>" method="get">
                <div class="row">
                   ...
                   <!-- <div class="col-sm-2 mb-3">
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="row">
                            ...
                            <div class="col-6">
                               <a href="<?= $panel_path.'fund/fund-convert-history'?>"  class="btnPrimary" name="submit">Reset</a>
                            </div>
                        </div>
                    </div>
                </div>
