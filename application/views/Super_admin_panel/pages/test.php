...
<!-- Mirrored from codervent.com/rukada/color-admin/components-switcher-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Jan 2020 17:48:26 GMT -->
<head>
  <meta charset="utf-8"/>
  ...
  <!-- simplebar CSS-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet"/>
  <!-- Bootstrap core CSS-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/css/bootstrap.min.css" rel="stylesheet"/>
   <!--Switchery-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/plugins/switchery/css/switchery.min.css" rel="stylesheet" />

  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/plugins/bootstrap-switch/bootstrap-switch.min.css" rel="stylesheet">
  <!-- animate CSS-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/css/animate.css" rel="stylesheet" type="text/css"/>
  <!-- Icons CSS-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/css/icons.css" rel="stylesheet" type="text/css"/>
  <!-- Sidebar CSS-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/css/sidebar-menu.css" rel="stylesheet"/>
  <!-- Custom Style-->
  <link href="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/css/app-style.css" rel="stylesheet"/>
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Switcher Buttons</h4>
		    <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Switcher Buttons</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
     <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-uppercase">Switch Buttons</div>
             <div class="card-body">
               <p class="text-muted"> add the following line <code> class="js-switch" data-color="#008cff"</code> to your input element. </p>
                    <div class="switchery-demo mt-3">
                     <input type="checkbox" checked class="js-switch" data-color="#008cff"/>
                     <input type="checkbox" checked class="js-switch" data-color="#15ca20"/>
                     <input type="checkbox" checked class="js-switch" data-color="#0dceec"/>
                     <input type="checkbox" checked class="js-switch" data-color="#75808a"/>
                     <input type="checkbox" checked class="js-switch" data-color="#fd3550"/>
                     <input type="checkbox" checked class="js-switch" data-color="#223035"/>
                     <input type="checkbox" checked class="js-switch" data-color="#ff9700"/>
                    </div>
                    
                    
                   <h4 class="mt-3">Large Sizes</h4>
                  <p class="text-muted"> You can add <code> data-size="large"</code> to your input element for different sizes. </p>
                  <div class="mt-3">
                      <input type="checkbox" checked class="js-switch" data-color="#008cff" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#15ca20" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#0dceec" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#75808a" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#fd3550" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#223035" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#ff9700" data-size="large"/>
                    </div>
                    
                    
                    <h4 class="mt-3">Small Sizes</h4>
                    <p class="text-muted"> You can add <code> data-size="small"</code> to your input element for different sizes. </p>
                    <div class="mt-3">
                      <input type="checkbox" checked class="js-switch" data-color="#008cff" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#15ca20" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#0dceec" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#75808a" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#fd3550" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#223035" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#ff9700" data-size="small"/>
                    </div>

                  <h4 class="mt-3">Secondary color</h4>
                  ...
                  <div class="mt-3">
                      <input type="checkbox" class="js-switch" data-color="#fd3550" data-secondary-color="#0dceec"/>
                      <input type="checkbox" class="js-switch" data-color="#223035" data-secondary-color="#75808a"/>
                    </div>  
             </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-uppercase">Bootstrap Switch Buttons</div>
             <div class="card-body bt-switch">
                <h4>Sizes</h4>
                  <p class="text-muted">Just add <code>data-size="Size"</code> attribute to the <code>&lt;input type="checkbox"...&gt;</code>. Size values: <code>mini, small, normal, large</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4>Colors</h4>
                  <p class="text-muted">Just add <code>data-on-color="Color"</code> & <code>data-off-color="Color"</code> to the <code>&lt;input type="checkbox"...&gt;</code>. Color values: <code>primary, info, success, warning, danger, default</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4 class="mt-3">Disabled/Readonly</h4>
                  <p class="text-muted">Just add <code>disabled</code> or <code>readonly</code> attribute to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4 class="mt-3">With Text</h4>
                  <p class="text-muted">Just add <code>data-on-text="Text"</code> & <code>data-off-text="Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4 class="mt-3">With Long Text</h4>
                  <p class="text-muted">Just add <code>data-on-text="Long Text"</code> & <code>data-off-text="Long Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-muted">Just add <code>data-on-text="Text"</code> or <code>data-off-text="Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4 class="mt-3">With HTML</h4>
                  <p class="text-muted">Just add <code>data-on-text="HTML Text"</code> & <code>data-off-text="HTML Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4 class="mt-3">Radio Buttons</h4>
                  <p class="text-muted">Just add class <code>radio-switch</code> to the <code>&lt;input type="radio"...&gt;</code>. If you want to change the class name, you have to change jquery according to that.</p>
                  <div class="mt-3">
  ...
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/js/jquery.min.js"></script>
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/js/popper.min.js"></script>
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/js/bootstrap.min.js"></script>
	
  <!-- simplebar js -->
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/plugins/simplebar/js/simplebar.js"></script>
  <!-- waves effect js -->
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/js/waves.js"></script>
  <!-- sidebar-menu js -->
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/js/sidebar-menu.js"></script>
  <!-- Custom scripts -->
  <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/js/app-script.js"></script>
  <!--Switchery Js-->
    <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/plugins/switchery/js/switchery.min.js"></script>
    <script>
    ...
    <script src="https://www.mlmreadymade.com/Super_admin_panel/s1/assets/plugins/bootstrap-switch/bootstrap-switch.min.js"></script>
    <script>
...
<!-- Mirrored from codervent.com/rukada/color-admin/components-switcher-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Jan 2020 17:48:31 GMT -->
</html>
