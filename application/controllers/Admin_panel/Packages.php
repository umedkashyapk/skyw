...
class Packages extends CI_Controller{
    ...
    public function index(){ 
        $searchdata['from_table']='pin_details';
        ...
        $data = $this->paging->search_response($searchdata,$this->limit,$this->admin_url.'/packages');
        $this->show->admin_panel('packages',$data);
    }
    ...
    public function edit(){
        ...
        if(isset($_POST['edit_btn'])){
            ...
            $update['bonus']=$this->input->post('bonus');
            $update['dtp']=$this->input->post('dtp');
            $update['subcription']=$this->input->post('subcription');
    ...
    public function create(){
        ...
        if(isset($_POST['add_btn'])){
           ...
           // $this->form_validation->set_rules('dtp', 'Dtp', 'required');
            if($this->form_validation->run() != False){
                ...
                $insert['bonus']=$this->input->post('bonus');
                $insert['dtp']=$this->input->post('dtp');
                $insert['subcription']=$this->input->post('subcription'); 
