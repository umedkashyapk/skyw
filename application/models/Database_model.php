...
class Database_model extends CI_Model{
    ...
    public function aes128Encrypt($data,$key){ 
    	$cipher = "aes-256-cbc";
    	$iv = 'gmaxx@gmaxx@';
    	$tag = "1234";
   ...
   function aes128Decrypt($ciphertext1,$key){
    	$cipher = "aes-256-cbc";
    	$iv = 'gmaxx@gmaxx@';
    	//$tag = "1234";
    	$original_plaintext = openssl_decrypt(base64_decode(trim($ciphertext1)), $cipher, $key, 0, $iv);
   ...
   public function get_input(){
    ...
    public function server_time(){
     ...
     public function generate_qrcode($referralCode){
          // Generate QR code filename
          
         $filename = FCPATH . base_url().'images/qr_code_new'. $referralCode.'.png';
            // Generate QR code
            generate_qrcode($referralCode, $filename);
